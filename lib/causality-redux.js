        ...
        var _loop2 = function _loop2(_o) {
            ...
            entry.changers[_o] = function (partitionName, changerName, changerArg) {
                return function () {
                    ...
                    obj.type = _typeof(changerArg.type) === undefinedString ? changerName : changerArg.type;
                    ...
                    if (isArrayOperation(changerArg.operation)) {
                        ...
                        if (changerArg.operation === _operations.STATE_ARRAY_DELETE || changerArg.operation === _operations.STATE_ARRAY_ENTRY_MERGE) obj.arrayArg = theArgs[0].toString();else obj.arrayArg = theArgs[0];
                    ...
                    return function (state, action) {
                        ...
                        switch (action.operation) {
                            ...
                            case _operations.STATE_ARRAY_ADD:
                                newArray = [].concat(_toConsumableArray(retObj[action.arrayName]));
                            ...
                            case _operations.STATE_ARRAY_DELETE:
                                newArray = retObj[action.arrayName].filter(function (entry) {
                            ...
                            case _operations.STATE_ARRAY_ENTRY_MERGE:
                                newArray = [].concat(_toConsumableArray(retObj[action.arrayName]));
                                index = retObj[action.arrayName].findIndex(function (entry) {
                                    return entry[action.keyName] === action.arrayArg;
                                });
                                if (index >= 0) {
