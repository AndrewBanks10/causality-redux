...
var internalSubscriber = function internalSubscriber(listener, partitionName) {var stateEntries = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];var listenerName = arguments[3];
...
var internalPartitionChanger = function internalPartitionChanger(store, stateEntry, o, reducerName) {
    return function () {var _stateEntry$changers;
...
var internalPartitionSubscriber = function internalPartitionSubscriber(partitionName) {
    return (
        function (listener, stateEntries) {var listenerName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
...
function init(partitionDefinitions, preloadedState, enhancer) {var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    ...
    var generalReducer = function generalReducer() {var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _defaultState;var action = arguments[1];
        ...
        newState[action.partitionName] = merge({}, state[action.partitionName], action.theirArgs);else
